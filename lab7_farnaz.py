...
def find_index(s, t):
    ...
    Returns:
    - (int): the lowest index of t in s, or -1 if it does not exist.
    """
    index = 0
...
def project_completion_day(day, days_to_completion):
    """
    This function calculates the day a project will be completed based
    on the starting day and number of days required.

    Parameters:
    - day (string): starting day of the week.
